...
namespace Opportunity.ChakraBridge.UWP
{
    partial struct JsContext
    {
        ...
        public static class Debugger
        {
            ...
            /// </para>
            /// </remarks>
            public static JsFunction ParseSerializedScriptWithCallback(JsSerializedScriptLoadSourceCallback scriptLoadCallback,
                JsSerializedScriptUnloadCallback scriptUnloadCallback, byte[] buffer, JsSourceContext sourceContext, string sourceUrl)
            {
            ...
            /// </para>
            /// </remarks>
            public static JsValue RunSerializedScriptWithCallback(JsSerializedScriptLoadSourceCallback scriptLoadCallback,
                JsSerializedScriptUnloadCallback scriptUnloadCallback, byte[] buffer, JsSourceContext sourceContext, string sourceUrl)
            {
                Native.JsRunSerializedScriptWithCallback(scriptLoadCallback, scriptUnloadCallback, buffer, sourceContext, sourceUrl, out var r).ThrowIfError();
